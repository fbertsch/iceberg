...
public class OutputFileFactory {
   ...
   *
   * This constructor is made public to assist Flink/Iceberg sink implementation at Netflix.
   * More context can be found at: https://jira.netflix.net/browse/RTDI-2531
   *
