...
public interface UpdateSchema extends PendingUpdate<Schema> {
   ...
   *
   * <p>The name is used to search for the column in historical schemas. The column is restored
   * with its original field ID, preserving data file compatibility. Restored columns are always
   * optional.
   *
