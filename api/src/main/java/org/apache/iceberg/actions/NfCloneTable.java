...
/** An action that creates a clone of an existing table. */
public interface NfCloneTable extends Action<NfCloneTable, NfCloneTable.Result> {
  /**
   ...
   */
  NfCloneTable tableProperties(Map<String, String> properties);
   ...
   * @return this for method chaining
   */
  NfCloneTable tableProperty(String key, String value);

  /** The action result that contains a summary of the execution. */
  interface Result {
    /** Returns the number of imported data files. */
    long clonedDataFilesCount();
  }
}
