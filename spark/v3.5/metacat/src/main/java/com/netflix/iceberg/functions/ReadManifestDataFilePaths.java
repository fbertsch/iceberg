...
public class ReadManifestDataFilePaths implements UnboundFunction {
  ...
  public String description() {
    return "ReadManifestDataFilePaths for " + ident;
  }
  ...
  private static class BoundManifestRead implements ScalarFunction<ArrayData> {
    ...
    public ArrayData produceResult(InternalRow input) {
      ...
      try (CloseableIterable<DataFile> files = ManifestFiles
          .unsafeRead(io.newInputFile(manifestPath))
    ...
    public DataType[] inputTypes() {
      return new DataType[] {new ArrayType(DataTypes.StringType, false /* does not contain null */)};
    }
