...
class FileFormatScan extends BaseScan {
  ...
  public boolean equals(Object o) {
    ...
    FileFormatScan that = (FileFormatScan) o;
    return Arrays.equals(pushedFilters, that.pushedFilters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(super.hashCode(), Arrays.hashCode(pushedFilters));
  }
